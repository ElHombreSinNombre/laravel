...
class PropietariosDataTable extends DataTable
{
    
    public function dataTable($query)
    {
        $propietarios = new EloquentDataTable($query);
        return $propietarios
        ->addColumn('action', function ($propietarios) {
            return 
                '<a data-toggle="tooltip" data-placement="top" title="Editar" href="' . route('propietarios.edit', [$propietarios->id]) . '"><i class="glyphicon glyphicon-edit"></i></a>'.
                '<a data-toggle="tooltip" data-placement="top" title="Eliminar" data-click="delete" data-elemento="'.$propietarios->codigo.'" data-route="' . route('propietarios.delete', [$propietarios->id]) . '"><i class="glyphicon glyphicon-remove"></i></a>';
            }); 
    }

    public function query(TrenPropietario $model)
    {
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->ajax([
                        'url'     => route('propietarios.listado'),
                    ]);
    }
    ...
    {
        return 'Listado de propietarios del ' . Carbon:: now()->format('d/m/Y H:i:s');
    }
