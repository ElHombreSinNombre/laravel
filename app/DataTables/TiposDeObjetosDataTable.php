...
class TiposDeObjetosDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $objetos = new EloquentDataTable($query);
        return $objetos
            //Columna Editar/Eliminar/Informe
            ->addColumn('action', function ($objetos) {
            return 
                '<a data-toggle="tooltip" data-placement="top" title="Editar" href="' . route('objetos.edit', [$objetos->id]) . '"><i class="glyphicon glyphicon-edit"></i></a>'.
                '<a data-toggle="tooltip" data-placement="top" title="Eliminar" data-click="delete" data-elemento="'.$objetos->nombre.'" data-route="' . route('objetos.delete', [$objetos->id]) . '"><i class="glyphicon glyphicon-remove"></i></a>';
            })      
            //Filtro
    ...
    public function query(TipoObjetoSiniestro $model)
    {
    ...
    {
        return 'Listado de objetos del ' . Carbon:: now()->format('d/m/Y H:i:s');
    }
}
