...
class VisitasDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $visitas
            ...
            return 
                '<a data-toggle="tooltip" data-placement="top" title="Editar" href="' . route('visitas.edit', [$visitas->id]) . '"><i class="glyphicon glyphicon-edit"></i></a>'.
                '<a data-toggle="tooltip" data-placement="top" title="Eliminar" data-click="delete" data-elemento="'.$visitas->nombre.'" data-route="' . route('visitas.delete', [$visitas->id]) . '"><i class="glyphicon glyphicon-remove"></i></a>';
            })   
            ...
            if (!empty($request->get('activo'))=='checked') {
                $query->whereNotNull('previsita');
            }
            if (!empty($request->get('activo'))!='checked') {
