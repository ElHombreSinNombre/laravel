...
class ReclamantesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $reclamantes = new EloquentDataTable($query);
        return $reclamantes
            //Columna Editar/Eliminar/Informe
            ->addColumn('action', function ($reclamantes) {
            return 
                '<a data-toggle="tooltip" data-placement="top" title="Editar" href="' . route('reclamantes.edit', [$reclamantes->id]) . '"><i class="glyphicon glyphicon-edit"></i></a>'.
                '<a data-toggle="tooltip" data-placement="top" title="Eliminar" data-click="delete" data-elemento="'.$reclamantes->nombre.'" data-route="'. route('reclamantes.delete', [$reclamantes->id]) . '"><i class="glyphicon glyphicon-remove"></i></a>';
            })      
            //Filtro
    ...
    public function query(Reclamante $model)
    {
    ...
    {
        return 'Listado de reclamantes del ' . Carbon:: now()->format('d/m/Y H:i:s');
    }
