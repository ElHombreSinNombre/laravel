...
class TiposDePolizasDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $polizas = new EloquentDataTable($query);
        return $polizas
            //Columna Editar/Eliminar/Informe
            ->addColumn('action', function ($polizas) {
            return 
                '<a data-toggle="tooltip" data-placement="top" title="Editar" href="' . route('polizas.edit', [$polizas->id]) . '"><i class="glyphicon glyphicon-edit"></i></a>'.
                '<a data-toggle="tooltip" data-placement="top" title="Eliminar" data-click="delete" data-elemento="'.$polizas->nombre.'" data-route="' . route('polizas.delete', [$polizas->id]) . '"><i class="glyphicon glyphicon-remove"></i></a>';
            })      
            //Filtro
    ...
    public function query(TipoPoliza $model)
    {
    ...
    {
        return 'Listado de polizas del ' . Carbon:: now()->format('d/m/Y H:i:s');
    }
}
