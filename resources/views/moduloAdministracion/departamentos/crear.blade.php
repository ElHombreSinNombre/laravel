...
@section('content')
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h5><a href="{{route('departamentos.listado')}}"><h5><i class="fa fa-chevron-circle-left" data-toggle="tooltip" data-placement="bottom" title="Atrás"></i></a><b> Modificación de departamentos</b></h5></div>
            {!! Form::open(['route' => 'departamentos.store']) !!}
                @include('moduloAdministracion.departamentos.formulario')
            {!! Form::close() !!}
        </div>
    </div>
@endsection
