...
@section('content')
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h5><a href="{{route('previsitas.listado')}}"><h5><i class="fa fa-chevron-circle-left" data-toggle="tooltip" data-placement="bottom" title="Atrás"></i></a><b> Modificación de previsitas</b></h5></div>
            {!! Form::model($previsita, ['route' => ['previsitas.update', $previsita->id], 'method' => 'patch']) !!}
                @include('moduloVisitas.previsitas.formulario')
            {!! Form::close() !!}
        </div>
    </div>
@endsection
