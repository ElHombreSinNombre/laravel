...
@section('content')
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h5><a href="{{route('dashboard')}}"><i class="fa fa-chevron-circle-left" data-toggle="tooltip" data-placement="bottom" title="Atrás"></i></a><b> Visitantes activos</b></h5></div>
