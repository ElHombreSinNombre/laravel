...
@section('content')
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h5><a href="{{url('polizas')}}"><h5><i class="fa fa-chevron-circle-left" data-toggle="tooltip" data-placement="bottom" title="Atrás"></i></a><b> Modificación de polizas</b></h5></div>
            {!! Form::model($poliza, ['route' => ['polizas.update', $poliza->id], 'method' => 'patch']) !!}
                @include('moduloSiniestros.tiposDepolizas.formulario')
            {!! Form::close() !!}
        </div>
    </div>
@endsection
