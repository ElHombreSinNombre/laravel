...
@section('content')
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h5><a href="{{url('objetos')}}"><h5><i class="fa fa-chevron-circle-left" data-toggle="tooltip" data-placement="bottom" title="Atrás"></i></a><b> Modificación de objetos</b></h5></div>
            {!! Form::model($objeto, ['route' => ['objetos.update', $objeto->id], 'method' => 'patch']) !!}
                @include('moduloSiniestros.tiposDeObjetos.formulario')
            {!! Form::close() !!}
        </div>
    </div>
@endsection
