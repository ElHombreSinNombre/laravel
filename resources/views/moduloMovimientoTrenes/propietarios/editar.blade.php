...
@section('content')
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h5><a href="{{url('propietarios')}}"><h5><i class="fa fa-chevron-circle-left" data-toggle="tooltip" data-placement="bottom" title="Atrás"></i></a><b> Modificación de propietarios</b></h5></div>
